...
patch_fstab fstab.qcom /cache ext4 options "barrier=1" "barrier=0,nomblk_io_submit";
patch_fstab fstab.qcom /data ext4 options "data=ordered" "nomblk_io_submit,data=writeback";
append_file fstab.qcom "usbdisk" fstab;
